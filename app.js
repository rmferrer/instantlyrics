...
/***/ function(module, exports, __webpack_require__) {
	...
	var _musixmatch = __webpack_require__(2);

	var _musixmatch2 = _interopRequireDefault(_musixmatch);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var express = __webpack_require__(41);
	var app = express();
	...
	app.get('/api/exactSong', function (req, res) {
	  ...
	  _musixmatch2.default.searchExactSong(search).then(function (response) {
	    res.send(response);
	  });
	});
	...
	app.get('/api/relatedSongs', function (req, res) {
	  ...
	  _musixmatch2.default.searchRelatedSongs(search).then(function (response) {
	    res.send(response);
	  });
	});

	app.get('/api/lyrics', function (req, res) {
	  _musixmatch2.default.getLyrics(req.query.track_id).then(function (response) {
	    res.send(response);
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _queryParse = __webpack_require__(38);
	...
	var MusixMatch = {
	  ...
	  searchExactSong: function searchExactSong(_ref) {
	    ...
	    var uri = this.MUSIXMATCH_ROOT_URL + '/matcher.track.get?' + _queryParse2.default.toString(params);
	    return _axios2.default.get(uri);
	  },

	  searchRelatedSongs: function searchRelatedSongs(_ref2) {
	    ...
	    var uri = this.MUSIXMATCH_ROOT_URL + '/track.search?' + _queryParse2.default.toString(params);
	    return _axios2.default.get(uri);
	  },

	  getLyrics: function getLyrics(track_id) {
	    var params = (0, _extend2.default)({ track_id: track_id }, this.BASE_PARAMS);
	    var uri = this.MUSIXMATCH_ROOT_URL + '/track.lyrics.get?' + _queryParse2.default.toString(params);
	    return _axios2.default.get(uri);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buildURL = __webpack_require__(9);
	var transformData = __webpack_require__(11);
	var http = __webpack_require__(16).http;
	var https = __webpack_require__(16).https;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var consume = __webpack_require__(27);
	...
	module.exports = {
		"_args": [
			[
				...
				"/Users/work/Developer/personal/instantlyrics"
			]
		],
		...
		"_shrinkwrap": null,
		"_spec": "axios@^0.9.1",
		"_where": "/Users/work/Developer/personal/instantlyrics",
		"author": {
			"name": "Matt Zabriskie"
		},
		"browser": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var proto = __webpack_require__(45);
	...
	exports.query = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var finalhandler = __webpack_require__(46);
	var Router = __webpack_require__(53);
	var methods = __webpack_require__(58);
	var middleware = __webpack_require__(67);
	var query = __webpack_require__(68);
	var debug = __webpack_require__(19)('express:application');
	var View = __webpack_require__(73);
	var http = __webpack_require__(28);
	var compileETag = __webpack_require__(74).compileETag;
	var compileQueryParser = __webpack_require__(74).compileQueryParser;
	var compileTrust = __webpack_require__(74).compileTrust;
	var deprecate = __webpack_require__(60)('express');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var statuses = __webpack_require__(50)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var codes = __webpack_require__(51)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pathRegexp = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var callSiteToString = __webpack_require__(61).callSiteToString
	var eventListenerCount = __webpack_require__(61).eventListenerCount
	var relative = __webpack_require__(65).relative
...
/***/ function(module, exports, __webpack_require__) {
	...
	lazyProperty(module.exports, 'bufferConcat', function bufferConcat() {
	  return Buffer.concat || __webpack_require__(62)
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var contentDisposition = __webpack_require__(75);
	var contentType = __webpack_require__(76);
	var deprecate = __webpack_require__(60)('express');
	var flatten = __webpack_require__(55);
	var mime = __webpack_require__(77).mime;
	var basename = __webpack_require__(65).basename;
	var etag = __webpack_require__(84);
	var proxyaddr = __webpack_require__(90);
	var qs = __webpack_require__(69);
	var querystring = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forwarded = __webpack_require__(91);
	var ipaddr = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./express.js": 42,
		"./middleware/init": 67,
		"./middleware/init.js": 67,
		"./middleware/query": 68,
		"./middleware/query.js": 68,
		"./request": 95,
		"./request.js": 95,
		"./response": 107,
		"./response.js": 107,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escapeHtml = __webpack_require__(47);
	var http = __webpack_require__(28);
	var isAbsolute = __webpack_require__(74).isAbsolute;
	var onFinished = __webpack_require__(48);
	var path = __webpack_require__(65);
	var merge = __webpack_require__(59);
	var sign = __webpack_require__(108).sign;
	var normalizeType = __webpack_require__(74).normalizeType;
	var normalizeTypes = __webpack_require__(74).normalizeTypes;
	var setCharset = __webpack_require__(74).setCharset;
	var statusCodes = http.STATUS_CODES;
	var cookie = __webpack_require__(109);
	var send = __webpack_require__(77);
	var extname = path.extname;
	var mime = send.mime;
	var resolve = path.resolve;
	var vary = __webpack_require__(110);
